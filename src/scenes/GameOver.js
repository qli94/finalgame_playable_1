class Gameover extends Phaser.Scene {
    ...
    preload() {
        this.load.image('Gameover', './assets/night_back03.png');
    }
    ...
    create() {
        ...
        this.add.text(game.config.width/2, game.config.height/2, 'If you are ready to re-start, please press SPACE', textConfig).setOrigin(0.5,1);
